  ...
  return (
    <div className="min-h-screen px-6 py-12">
      ...
      >
        ...
        {/* Additional info */}
        <div className="mt-12 p-6 bg-gradient-to-br from-accent-500/10 to-accent-700/10 border border-accent-500/20 rounded-2xl">
          <div className="flex items-center justify-center gap-3">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-accent-500 to-accent-700 flex items-center justify-center flex-shrink-0 shadow-lg shadow-accent-500/30">
