...
export default function AboutDesktopGitHub() {
            ...
            {user && (
              <div className="grid grid-cols-3 gap-4">
                <div className="text-center p-4 bg-white/5 border border-white/10 rounded-xl">
                  <div className="text-2xl font-bold text-accent-500">{user.public_repos}</div>
                  <div className="text-xs text-gray-400">Repositórios</div>
                </div>
                <div className="text-center p-4 bg-white/5 border border-white/10 rounded-xl">
                  <div className="text-2xl font-bold text-accent-500">{user.followers}</div>
                  <div className="text-xs text-gray-400">Seguidores</div>
                </div>
                <div className="text-center p-4 bg-white/5 border border-white/10 rounded-xl">
                  <div className="text-2xl font-bold text-accent-500">{user.following}</div>
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              {user?.bio ? (
                ...
                <>
                  <p className="text-gray-300 text-lg leading-relaxed">
                    Olá! Sou um desenvolvedor full-stack apaixonado com experiência criando
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                Quando não estou programando, você me encontrará contribuindo para projetos open-source, 
                escrevendo artigos técnicos ou explorando novos frameworks.
              </p>
            </div>
          </div>
        </div>
